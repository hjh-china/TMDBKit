...
///   - Changes model.
public class TMKTVEpisodesAPIWrapper: TMKAPIWrapper {
    ...
    public func getDetails(forTVShow tvShow: Int,
                           ...
                           episodeNum: Int,
                           language: String? = nil,
                           completion: @escaping TMKObjectHandler<TMDBTVEpisodeDetailed>) {
    ...
    public func getCredits(forTVShow tvShow: Int,
                           ...
                           episodeNum: Int,
                           language: String? = nil,
                           completion: @escaping TMKObjectHandler<TMDBTVEpisodeCredits>) {
    ...
    public func getImages(forTVShow tvShow: Int,
                          ...
                          completion: @escaping TMKObjectHandler<TMDBStills>) {
