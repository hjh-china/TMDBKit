...
public class TMKAPIWrapper {
    ...
    func performRequest(method: String = "GET",
        ...
        performRequest(method: method,
                       ...
                       data: data,
                       authentication: authentication,
                       expectedStatusCode: expectedStatusCode) { (result: TMKDataReturn) in
            switch result {
    ...
    func performRequest<T>(method: String = "GET",
                           ...
                           authentication: TMDBAuthenticationType = .noAuthentication,
                           expectedStatusCode: Int = 200,
                           completion: @escaping TMKObjectHandler<T>) {
        performRequest(method: method,
                       path: path,
                       query: query,
                       headers: headers,
    ...
    func performRequest<T>(method: String = "GET",
                           ...
                           authentication: TMDBAuthenticationType = .noAuthentication,
                           expectedStatusCode: Int = 200,
                           completion: @escaping TMKJSONInitableHandler<T>) {
        performRequest(method: method,
                       path: path,
                       query: query,
                       headers: headers,
                       data: data,
                       authentication: authentication,
                       expectedStatusCode: expectedStatusCode) { (result: TMKJSONReturn) in
            switch result {
