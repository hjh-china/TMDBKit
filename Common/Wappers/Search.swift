...
/// - TODO: Multi search.
public class TMKSearchAPIWrapper: TMKAPIWrapper {
    /// Search Companies.
    ///
    /// - Parameters:
    ...
    public func search(company: String,
                       page: Int? = nil,
                       completion: @escaping TMKObjectHandler<TMDBPaged<TMDBCompanyBasic>>) {
    ...
    public func search(collection: String,
                       language: String? = nil,
                       page: Int? = nil,
                       completion: @escaping TMKObjectHandler<TMDBPaged<TMDBCollectionBasic>>) {
    ...
    public func search(keyword: String,
                       page: Int? = nil,
                       completion: @escaping TMKObjectHandler<TMDBPaged<TMDBKeyword>>) {
